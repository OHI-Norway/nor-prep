...
catch_prep_spread<- dplyr::left_join(catch_prep_spread, munic, by =c("landing_municip" = "Name"))
...
catch_prep_spread<- catch_prep_spread %>%
  ...
  select(-("Kid")) %>%
  mutate(landing_county = ifelse(landing_municip_numb %in% 1804:1874, "Nordland",
...
#write.csv(catch_prep,"C:/Users/sigrid.engen/github/nor-prep/prep/small_sc_fisheries/data/Catch_local_total_2000_2019.csv")
```
## Plotting 
...
## Which municipalities have fish landing sites
