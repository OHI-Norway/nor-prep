...
https://www.fiskeridir.no/Tall-og-analyse/AApne-data/AApne-datasett/Fangstdata-koblet-med-fartoeydata
...
# Cleaning and formatting fish older (1994 - 2017) landings data: cheking species names
```{r, results="hide"}
...
Grenland halibut is not in the list of species.
```{r}
fishnames <- 
...
In 2018, catches are in kg while in other years - in tons. I divide catches by 1000, to have them in tons.
```{r}
...
# Save catch table
```{r}
#write.csv(catch_total, "data/catch_total.csv", row.names = F)
```
