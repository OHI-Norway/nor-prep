...
I also suspect that the same stock were uploaded to the database under different names, such as cod-arct and cod.27.1-2 have similar stock decription (both are NEA cod). Same problem occured for haddock  (had-arct and had.27.1-2(), saithe (pok.27.1-2 and sai-arct),  redfish (	reg.27.1-2 and smr-arct), and halibut (ghl-arct and  ghl.27.1-2) which are the same stocks.

I observed also that stock stats for mackerel are duplicated, but SSB and F vary slightly between the duplicates. Likely, this is because data came from two databases, or two assessments. I cannot see how to distinguish between the two asessments, so I just keep the first row of the each pair of dulicated rows. The difference in SSB and F values is small and will not affect our analysis. 
...
http://ices.dk/sites/pub/Publication%20Reports/Advice/2014/2014/sai-arct.pdf. 
...
I will assume that Greenland halibut and golden redifsh are sustainable, and just allocate score 1 to them.
Also, adding English names of the species.
