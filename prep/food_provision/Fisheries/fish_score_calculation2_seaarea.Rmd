...
```{r }
ices <- read.csv("data/ices_updated_2018.csv")
...
# Examining the distribution of total catch by species regardless of municipality
```{r}
...
mosaic::fav_stats(weighted_biomass_score$biomass.area)
# min     Q1 median   Q3  max mean   sd    n missing
#  0.000000578 0.0397  0.227 1.03 64.1 1.35 3.67 5563  0
```
