...
# Examin the distribution of total catch by species regardless of municipality
```{r}
...
# Option: applying rolling mean to the final fisheries score bbased on non-smoothed catches
