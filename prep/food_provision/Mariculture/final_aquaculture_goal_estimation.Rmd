...
I also calculate the 75th qunatile of the total production within a year, and estiamte proportion of production in each municipality and year to this qunatile
...
```
Check the distribution of aquaculture scores if we use 0.75th qunatile of production as a maximum
```{r}
