...
If we would ignore such a case, we would get NA for produciton in Evenes in 2016, but this is not correct.
...
```{r}
#write.csv(efcr_score, "data/total_aquaculture_production_and_efcr.csv", row.names = FALSE)
```
