...
# Prepare final dataset with total number of localities with over-threshold lice cound
Select only locations were counting lice. I do not filter out inactive locaitons, because obviously, they did not count lice.
...
```{r}
above_threhold_locs_tototal <- above_threhold_locs %>%
