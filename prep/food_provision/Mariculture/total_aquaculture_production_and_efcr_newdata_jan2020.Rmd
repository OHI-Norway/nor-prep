---
title: "Total aquaculture production using updated production data"
...
# Loading aquaculture produciton data with feed used, biomass change per month, lost fish and seeded fish.
```{r}
...
$ot.prod = \triangle Biomass + harvest - discard - seeded.smolts$
```{r}
...
```{r}
#write.csv(production_efcr, "data/total_municipality_aquaculture__production_and_efcr.csv", row.names = FALSE)
```



# Calulating eFCR per region
NB! This time I will not use the amount of fish moved to the municipality, because I don't know the weight of fish moved (there is no data on that). 
