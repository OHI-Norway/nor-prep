...
The values of eFCR that are out of possible bounds (lower than 1.3), we will consider as flaws, and replace with a national average - 1.3 for year 2016 and 2012. We can expect the eFCR to be somewhat higher than 1.3, or rarely - much higher, when a lot of fish lost or discarded, but practically, eFCR cannot be lower than 1.3. It is in principle not  possible to apply X kg of feed to yield exactly X kg of fish. 
